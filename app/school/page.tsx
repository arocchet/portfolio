    ...
    <div className="relative flex h-full w-full flex-col bg-background dark:bg-black-90 light:bg-white-90 text-justify hyphens-auto leading-relaxed">
      <main className="container mx-auto flex flex-col items-center justify-center px-8 py-16 sm:py-24">
        ...
        <section className="flex flex-col items-center justify-center gap-8 sm:gap-6">
          ...
          <p className="text-lg sm:text-xl text-default-500 max-w-3xl">
            The goal is to train as a full-stack developer in 3 years, through work-study. From design to production of a project or application, I work with different programming languages. The approach is agile and collaborative, transforming me from a beginner to a developer of complete software. By completing more than 55 projects and 250 code audits. I'm learning to code in JavaScript, Go, Rust, as well as in C, C++, Java, Python, and many more. This allows of coding in any programming environment.
          </p>
          <h1 className="text-center text-4xl sm:text-5xl font-bold leading-tight text-default-700">
